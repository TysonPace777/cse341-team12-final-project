...
router.post("/", isAuthenticated, utilities.handleErrors(taskController.createTask));

router.put("/:id", isAuthenticated, utilities.handleErrors(taskController.updateTask));
